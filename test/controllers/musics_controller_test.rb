...
class MusicsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create music" do
    assert_difference("Music.count") do
      post musics_url, params: { music: { arranger: @music.arranger, composer: @music.composer, length: @music.length, lyricist: @music.lyricist, name: @music.name } }
    end
  ...
  test "should update music" do
    patch music_url(@music), params: { music: { arranger: @music.arranger, composer: @music.composer, length: @music.length, lyricist: @music.lyricist, name: @music.name } }
